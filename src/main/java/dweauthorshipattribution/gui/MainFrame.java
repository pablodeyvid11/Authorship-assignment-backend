...
public class MainFrame extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		executeTestButton.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent evt) {
				executeTestButtonActionPerformed(evt);
			}
		});
	...
	private void executeTestButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_executeTestButtonActionPerformed
		...
		if (arquivosTesteCarregados == null || arquivosTesteCarregados.size() == 0) {
			JOptionPane.showMessageDialog(this, "Select a text file!", "Error", JOptionPane.ERROR_MESSAGE);
			return;
		}

		if (arquivosTesteCarregados.size() != dialogLoadedAuthors.getAuthors().size()) {
			JOptionPane.showMessageDialog(this, "Test files loaded and registered authors must have the same amount!",
					"Error", JOptionPane.ERROR_MESSAGE);
			return;
		}

//		for (AuthorIF autoresTreinados : dialogLoadedAuthors.getAuthors()) {
//			for (TextFile tf : arquivosTesteCarregados) {
//				if (!autoresTreinados.getAuthorName().substring(0, 5).equals(tf.getName().substring(0, 5))) {
//					JOptionPane.showMessageDialog(this,
//							"The name of the test files must be the same as the files of the trained authors!", "Error",
...
//		}
		...
		File f = new File(System.getProperty("user.dir") + "\\relatoriosTeste\\base.bin");
		if (!f.exists()) {
		...
		String path = System.getProperty("user.dir") + "\\relatoriosTeste\\" + "RELATORIO" + sdf.format(data) + ".txt";

		File f2 = new File(path);
		if (!f2.exists()) {
			if (f2.getParentFile() != null) {
				if (!f2.getParentFile().exists()) { // pega tudo que tem antes do arquivo
		...
		Thread t = new Thread() {
			...
			public void run() {
				for (AuthorIF aIF : map.keySet()) {
					...
					System.out.println(map.get(aIF).getExist());
...
//					bw.write(cont + "∫: Author's name: " + author.getAuthor() + "; File length: "
...
//		}
	...
	public void setResult(AuthorshipAllocatorResultIF result) {
		...
		for (int i = 0; i < authorsResult.length; i++) {
			...
			v.add(((i + 1) + "∫ - ") + authorsResult[i].getAuthor().getAuthorName());
