package dweauthorshipattribution.persistence;
...
/**
 * Classe de configuracao do hibernate.
 *
 * <br><br>
 ...
 * @see www.di.ufpb.br
 */
public class DWEPersistenceUtil {

    static {
        try {
            // Create the SessionFactory from standard (hibernate.cfg.xml) 
            // config file.
            entitityManager = Persistence.createEntityManagerFactory("DWEAuthorshipAttribution").createEntityManager();
    ...
    public static final EntityManager entitityManager;
}
